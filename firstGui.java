...
/* Version 0.1
   ...
   when pressed each send different messages as well as there being two text fields one editable one uneditable
   */
...
public class firstGuiPgm {
     ...
     */
    static JLabel label;
    static JTextField editableText, uneditableText;
